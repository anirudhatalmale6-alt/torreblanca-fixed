...
const ASSET_DIR = "./assets/apto-04/";
const APTO_PREFIX = "apto-04-";
...
const AREAS = {
  ...
  "cocina-comedor": { title: "COCINA / COMEDOR", mask: "apto-04-mask-cocina-comedor.jpg", kind: "detail" },
  "sala":           { title: "SALA",            mask: "apto-04-mask-sala.jpg",           kind: "detail" },
  "terraza":        { title: "TERRAZA",         mask: "apto-04-mask-terraza.jpg",        kind: "detail" },
  "master-bedroom": { title: "MASTER BEDROOM",  mask: "apto-04-mask-master-bedroom.jpg", kind: "detail" },
  "habitacion-2":   { title: "HABITACIÓN 2",    mask: "apto-04-mask-habitacion-2.jpg",   kind: "detail" },
  "habitacion-3":   { title: "HABITACIÓN 3",    mask: "apto-04-mask-habitacion-3.jpg",   kind: "detail" },

  // INFORMATIVO (solo HUD)
  "cubo-de-luz": { title: "CUBO DE ILUMINACIÓN", mask: "apto-04-mask-cubo-de-luz.jpg", kind: "info" },
  "elevador":    { title: "ELEVADOR",            mask: "apto-04-mask-elevador.jpg",     kind: "info" },
  "gradas":      { title: "GRADAS",              mask: "apto-04-mask-gradas.jpg",       kind: "info" },
  "todos-los-banos":   { title: "TODOS LOS BAÑOS",   mask: "apto-04-mask-todos-los-banos.jpg",   kind: "info" },
  "todos-los-closets": { title: "TODOS LOS CLOSETS", mask: "apto-04-mask-todos-los-closets.jpg", kind: "info" },
  "lavanderia-y-cuarto-muchacha": { title: "LAVANDERÍA Y CUARTO MUCHACHA", mask: "apto-04-mask-lavanderia-y-cuarto-muchacha.jpg", kind: "info" },
};
...
function openGallery(){
  ...
  Object.entries(AREAS).forEach(([key, a]) => {
    ...
    // portada: apto-04-<key>-1.(jpg|jpeg|png) => intentamos jpg primero
...
(function(){
  try{
    const ASSET_DIR_LOCAL = (typeof ASSET_DIR !== "undefined") ? ASSET_DIR : "./assets/apto-04/";
    ...
    if(planoBtn){
      planoBtn.addEventListener("click", (e) => {
        ...
        openPdfLocal("apto-04-plano.pdf");
      });
    }
    if(ubiBtn){
      ubiBtn.addEventListener("click", (e) => {
        e.preventDefault(); e.stopPropagation();
        openPdfLocal("apto-04-ubicacion.pdf");
      });
    }
  }catch(err){}
})();
